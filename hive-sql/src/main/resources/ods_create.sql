...
load data inpath '/origin_data/gmall/db/activity_rule_full/2020-06-14' OVERWRITE into table ods_activity_rule_full partition (dt = '2020-06-14');
...
(
    `type` STRING COMMENT '变动类型',
    `ts`   BIGINT COMMENT '变动时间',
    `data` STRUCT<id :STRING, out_trade_no :STRING, order_id :STRING,user_id :STRING, payment_type :STRING,trade_no:STRING,
                    total_amount :DECIMAL(16, 2),subject :STRING,payment_status :STRING,create_time :STRING,callback_time
